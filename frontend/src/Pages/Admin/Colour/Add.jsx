  ...
  return (
    <div className=' mt-3'>
      ...
      <form className="max-w-sm mx-auto mt-6" onSubmit={submitHandler} encType='multipart/form-data'>
        <div className="mb-5">
          <label htmlFor="name" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Color Name</label>
        ...
        <div className="mb-5">
          <label htmlFor="slug" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Color Slug</label>
